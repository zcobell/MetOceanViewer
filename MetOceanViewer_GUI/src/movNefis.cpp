...
MovNefis::MovNefis(QString defFilename, QString datFilename, QObject *parent) : QObject(parent)
{
...
int MovNefis::_generatePlotVariableList()
{
...
QStringList MovNefis::getSeriesNames()
{
    return this->_mSeriesNames;
}


QString MovNefis::getSeriesDescription(QString seriesName)
{
    return this->_mSeriesDescriptionsMap[seriesName];
}


int MovNefis::open(bool fullInit)
{
    BInt4 ierr;
    BText datFile;
    BText defFile;
...
int MovNefis::_init(bool fullInit)
{
...
int MovNefis::_getStationLocations()
{
    int     i,j;
    BInt4   nSta;
...
int MovNefis::_getSeriesNames(QString seriesGroup, QVector<QString> &seriesNames,
...
int MovNefis::_get(QString seriesName)
{
...
int MovNefis::generateIMEDS(QString seriesName, MovImeds *stationData, int layer)
{
    int i,ierr,_layer;
    ...
    {
        stationData->station[i] = new MovImedsStation(this);
...
QString MovNefis::getNefisDatFilename(QString defFilename)
{
    return defFilename.mid(0,defFilename.length()-3)+QStringLiteral("dat");
}


QString MovNefis::getNefisDefFilename(QString datFilename)
{
    return datFilename.mid(0,datFilename.length()-3)+QStringLiteral("def");
}

int MovNefis::getNumLayers()
{
