...
MovHwm::MovHwm(QLineEdit *inFilebox, QCheckBox *inManualCheck,
               ...
               MovQChartView *inChartView, QStatusBar *inStatusBar,
...
QString MovHwm::getErrorString() { return this->hwmErrorString; }
...
int MovHwm::plotRegression() {
  ...
  One2OneColor =
      MovColors::styleSheetToColor(this->button121LineColor->styleSheet());
  BoundColor =
      MovColors::styleSheetToColor(this->buttonBoundingLinecolor->styleSheet());
  RegColor =
      MovColors::styleSheetToColor(this->buttonRegLineColor->styleSheet());
