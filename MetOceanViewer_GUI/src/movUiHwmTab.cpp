...
void mov_window_main::on_browse_hwm_clicked()
{
    ...
    MovGeneric::splitPath(HighWaterMarkFile,filename,this->PreviousDirectory);
...
void mov_window_main::on_button_processHWM_clicked()
{
    ...
    thisHWM = new MovHwm(ui->Text_HWMFile,ui->check_manualHWM,ui->combo_hwmunits,
...
void mov_window_main::on_button_hwmcolor_clicked()
{
    ...
    ButtonStyle = MovColors::MakeColorString(DotColorHWM);
...
void mov_window_main::on_button_121linecolor_clicked()
{
    ...
    ButtonStyle = MovColors::MakeColorString(LineColor121Line);
...
void mov_window_main::on_button_reglinecolor_clicked()
{
    ...
    ButtonStyle = MovColors::MakeColorString(LineColorRegression);
...
void mov_window_main::on_button_boundlinecolor_clicked()
{
    ...
    ButtonStyle = MovColors::MakeColorString(LineColorBounds);
