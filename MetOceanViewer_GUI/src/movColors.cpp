...
MovColors::MovColors(QObject *parent) : QObject(parent)
{
...
//-------------------------------------------//
QString MovColors::MakeColorString(QColor InputColor)
{
...
QString MovColors::getHexColor(QColor InputColor)
{
...
QColor MovColors::styleSheetToColor(QString stylesheet)
{
    QColor thisColor;
    QString colorString;
...
//-------------------------------------------//
QColor MovColors::GenerateRandomColor()
{
    QColor MyColor, Mix;
    QTime SeedTime;
