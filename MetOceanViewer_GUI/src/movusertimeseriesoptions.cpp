...
movUserTimeseriesOptions::movUserTimeseriesOptions(QWidget *parent)
    : QDialog(parent), ui(new Ui::movUserTimeseriesOptions) {
  ui->setupUi(this);
  this->_mDisplayValues = false;
  this->_mHideInfoWindows = false;
}

movUserTimeseriesOptions::~movUserTimeseriesOptions() { delete ui; }

bool movUserTimeseriesOptions::displayValues() { return this->_mDisplayValues; }
