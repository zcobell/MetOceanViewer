...
bool operator>(const mov_dialog_update::gitVersion version1,
               const mov_dialog_update::gitVersion version2) {
...
mov_dialog_update::mov_dialog_update(QWidget *parent)
    : QDialog(parent), ui(new Ui::mov_dialog_update) {
  ui->setupUi(this);
...
mov_dialog_update::~mov_dialog_update() { delete ui; }

int mov_dialog_update::getLatestVersionData() {
...
void mov_dialog_update::parseUpdateData() {
  int ierr;
...
void mov_dialog_update::runUpdater() {
  int ierr;
...
bool mov_dialog_update::checkForUpdate() {
  int ierr;
...
int mov_dialog_update::parseGitVersion(QString versionString,
                                       gitVersion &version) {
  QString v1, v2, v3;
  QStringList v1L, v2L;
...
void mov_dialog_update::setDialogText() {
  QString dialogHTML;
...
void mov_dialog_update::on_button_ok_clicked() { this->accept(); }
