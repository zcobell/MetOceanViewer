...
bool operator>(const mov_dialog_update::gitVersion version1, const mov_dialog_update::gitVersion version2)
{
...
int mov_dialog_update::parseGitVersion(QString versionString, gitVersion &version)
{
    QString v1,v2,v3;
    QStringList v1L,v2L;
...
void mov_dialog_update::on_button_ok_clicked()
{
    this->accept();
}
