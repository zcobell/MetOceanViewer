...
MovUsgs::MovUsgs(QWebEngineView *inMap,
...
int MovUsgs::formatUSGSInstantResponse(QByteArray Input)
{
    bool doubleok;
...
int MovUsgs::formatUSGSDailyResponse(QByteArray Input)
{
...
int MovUsgs::getDataBounds(double &ymin, double &ymax)
{
    int j;
...
int MovUsgs::replotCurrentUSGSStation(int index)
{
    int ierr;
...
int MovUsgs::readUSGSDataFinished(QNetworkReply *reply)
{
    int ierr;
...
int MovUsgs::saveUSGSData(QString filename, QString format)
{
...
int MovUsgs::setUSGSBeenPlotted(bool input)
{
    this->USGSBeenPlotted = input;
    return 0;
}

QString MovUsgs::getClickedUSGSStation()
{
    QString JunkString;
...
QString MovUsgs::getLoadedUSGSStation()
{
    return this->USGSMarkerID;
}


void MovUsgs::setAsyncMarkerSelection()
{
...
QString MovUsgs::getMarkerSelection(QString &name, double &longitude, double &latitude)
{
...
int MovUsgs::setMarkerSelection()
{
...
bool MovUsgs::getUSGSBeenPlotted()
{
    return this->USGSBeenPlotted;
}

QString MovUsgs::getUSGSErrorString()
{
