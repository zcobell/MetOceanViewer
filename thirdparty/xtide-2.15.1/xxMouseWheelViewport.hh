// $Id: xxMouseWheelViewport.hh 4501 2012-05-27 17:41:58Z flaterco $
...
private:
  ...
  xxMouseWheelViewport (const xxMouseWheelViewport &);
  xxMouseWheelViewport &operator= (const xxMouseWheelViewport &);
};
