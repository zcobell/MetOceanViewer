 ...
 private:
  const std::vector<NoaaProduct> m_products = {
      NoaaProduct("6 minute water level vs predicted water level",
                  ...
                  "m", "ft", "Water Level", true, 2),
      NoaaProduct("6 minute water level", {"water_level"}, {"Observed"}, "m",
                  "ft", "Water Level", true, 1),
      NoaaProduct("Predicted water level", {"predictions"}, {"Predicted"}, "m",
                  "ft", "Water Level", true, 1),
      NoaaProduct("Hourly water level", {"hourly_height"}, {"Observed"}, "m",
                  "ft", "Water Level", true, 1),
      NoaaProduct("Air temperature", {"air_temperature"}, {"Observed"}, "c",
                  "f", "Temperature", false, 1),
      NoaaProduct("Water temperature", {"water_temperature"}, {"Observed"},
                  "celcius", "fahrenheit", "Temperature", false, 1),
      NoaaProduct("Wind speed", {"wind:speed"}, {"Observed"}, "m/s", "kt",
                  "Wind Speed", false, 1),
      NoaaProduct("Humidity", {"humidity"}, {"Observed"}, "%", "%",
      ...
      NoaaProduct("Wind Gusts", {"wind:gusts"}, {"Observed"}, "m/s", "kt",
                  "Gust Speed", false, 1)};
};
